...
END
  ...
  BEGIN TRANSACTION
  UPDATE VEHICLE SET [CAR_TYPE_ID] = @p_CAR_TYPE_ID,[NAME] = @p_NAME,[OG_COUNTRY] = @p_OG_COUNTRY,[BRAND] = @p_BRAND,[MANAGING_UNIT] = @p_MANAGING_UNIT,[FUEL] = @p_FUEL,[CONSUMPTION] = @p_CONSUMPTION
...
AS
BEGIN TRANSACTION
  INSERT INTO VEHICLE([CAR_ID],[CAR_TYPE_ID],[NAME],[OG_COUNTRY],[BRAND],[MANAGING_UNIT],[FUEL],[CONSUMPTION])
  VALUES (@p_CAR_ID, @p_CAR_TYPE_ID, @p_NAME, @p_OG_COUNTRY, @p_BRAND, @p_MANAGING_UNIT, @p_FUEL, @p_CONSUMPTION)
IF @@Error <> 0 GOTO ABORT
  COMMIT TRANSACTION
